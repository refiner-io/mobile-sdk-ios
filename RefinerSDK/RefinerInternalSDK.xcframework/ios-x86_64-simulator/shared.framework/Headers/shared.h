...
@class SharedEnvironment, SharedKermitLogger, SharedKoin_coreKoin, SharedBaseResponse, SharedDataState<__covariant T>, SharedAnySerializer, SharedRefinerSettings, SharedBaseResponseCompanion, SharedDataStateCompanion, SharedKotlinArray<T>, SharedRefinerConfigs, SharedFormActionRequestCompanion, SharedFormActionRequest, SharedIdentifyUserRequestCompanion, SharedIdentifyUserRequest, SharedShowFormRequestCompanion, SharedShowFormRequest, SharedSubmitFormRequestCompanion, SharedSubmitFormRequest, SharedTrackEventRequestCompanion, SharedTrackEventRequest, SharedTrackScreenRequestCompanion, SharedTrackScreenRequest, SharedRefinerModelCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreModule, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinx_serialization_jsonJsonElement, SharedKoin_coreKoinApplication, NSUserDefaults, SharedKermitLoggerCompanion, SharedKotlinThrowable, SharedKermitSeverity, SharedKotlinUnit, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreHttpClient, SharedKtor_client_coreHttpClientEngineConfig, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKoin_coreParametersHolderCompanion, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKotlinx_serialization_jsonJsonElementCompanion, SharedKoin_coreKoinApplicationCompanion, SharedKermitLogWriter, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpStatusCode, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKtor_client_coreProxyConfig, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpContentType, SharedKotlinCancellationException, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_client_coreHttpClientCallCompanion, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKotlinByteArray, SharedKtor_ioByteReadPacket, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpURLBuilderCompanion, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioBuffer, SharedKtor_ioChunkBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinKTypeProjection, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion;

@protocol SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreCoroutineScope, SharedKoin_coreKoinComponent, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_coroutines_coreFlow, SharedKotlinComparable, SharedRefinerApi, SharedKtor_client_coreHttpClientEngine, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedKotlinIterator, SharedAppInfo, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKermitLoggerConfig, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_ioCloseable, SharedKoin_coreScopeCallback, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKtor_httpHeaders, SharedKotlinx_coroutines_coreJob, SharedKtor_utilsAttributes, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKtor_httpParameters, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_client_coreHttpClientPlugin, SharedKotlinSuspendFunction2, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKotlinFunction, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedKtor_ioObjectPool;
...
@property (readonly) SharedEnvironment *environment __attribute__((swift_name("environment")));
@end;
...
- (instancetype)initWithMainContext:(id<SharedKotlinCoroutineContext>)mainContext log:(SharedKermitLogger *)log __attribute__((swift_name("init(mainContext:log:)"))) __attribute__((objc_designated_initializer));
...
@interface SharedNativeViewModel : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)dismissFormFormUuid:(NSString *)formUuid onDismissFormState:(void (^)(SharedDataState<SharedBaseResponse *> *))onDismissFormState __attribute__((swift_name("dismissForm(formUuid:onDismissFormState:)")));
- (void)identifyUserContactAttributes:(id _Nullable)contactAttributes onIdentifyUserState:(void (^)(SharedDataState<SharedBaseResponse *> *))onIdentifyUserState __attribute__((swift_name("identifyUser(contactAttributes:onIdentifyUserState:)")));
- (void)markFormAsShownFormUuid:(NSString *)formUuid onMarkFormAsShownState:(void (^)(SharedDataState<SharedBaseResponse *> *))onMarkFormAsShownState __attribute__((swift_name("markFormAsShown(formUuid:onMarkFormAsShownState:)")));
- (void)onDestroy __attribute__((swift_name("onDestroy()")));
...
- (void)showFormFormUuid:(NSString *)formUuid force:(BOOL)force onShowFormState:(void (^)(SharedDataState<SharedBaseResponse *> *))onShowFormState __attribute__((swift_name("showForm(formUuid:force:onShowFormState:)")));
- (void)submitFormContactAttributes:(id _Nullable)contactAttributes accountAttributes:(id _Nullable)accountAttributes formUuid:(NSString *)formUuid onSubmitFormState:(void (^)(SharedDataState<SharedBaseResponse *> *))onSubmitFormState __attribute__((swift_name("submitForm(contactAttributes:accountAttributes:formUuid:onSubmitFormState:)")));
- (void)trackEventEventName:(NSString *)eventName onTrackEventState:(void (^)(SharedDataState<SharedBaseResponse *> *))onTrackEventState __attribute__((swift_name("trackEvent(eventName:onTrackEventState:)")));
- (void)trackScreenScreenName:(NSString *)screenName onTrackScreenState:(void (^)(SharedDataState<SharedBaseResponse *> *))onTrackScreenState __attribute__((swift_name("trackScreen(screenName:onTrackScreenState:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> dismissFormStateFlow __attribute__((swift_name("dismissFormStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> identifyUserStateFlow __attribute__((swift_name("identifyUserStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> markFormAsShownStateFlow __attribute__((swift_name("markFormAsShownStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> partialSubmitFormStateFlow __attribute__((swift_name("partialSubmitFormStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> showFormStateFlow __attribute__((swift_name("showFormStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> submitFormStateFlow __attribute__((swift_name("submitFormStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> trackEventStateFlow __attribute__((swift_name("trackEventStateFlow")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> trackScreenStateFlow __attribute__((swift_name("trackScreenStateFlow")));
@end;
...
@interface SharedAnySerializer : SharedBase <SharedKotlinx_serialization_coreKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)anySerializer __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedAnySerializer *shared __attribute__((swift_name("shared")));
- (id)deserializeDecoder:(id<SharedKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<SharedKotlinx_serialization_coreEncoder>)encoder value:(id)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<SharedKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefinerSettings")))
@interface SharedRefinerSettings : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)refinerSettings __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRefinerSettings *shared __attribute__((swift_name("shared")));
...
- (instancetype)initWithComponent:(NSString * _Nullable)component componentData:(id _Nullable)componentData message:(NSString * _Nullable)message onPageDelay:(SharedInt * _Nullable)onPageDelay styles:(id _Nullable)styles __attribute__((swift_name("init(component:componentData:message:onPageDelay:styles:)"))) __attribute__((objc_designated_initializer));
...
- (SharedBaseResponse *)doCopyComponent:(NSString * _Nullable)component componentData:(id _Nullable)componentData message:(NSString * _Nullable)message onPageDelay:(SharedInt * _Nullable)onPageDelay styles:(id _Nullable)styles __attribute__((swift_name("doCopy(component:componentData:message:onPageDelay:styles:)")));
...
@property (readonly) SharedInt * _Nullable onPageDelay __attribute__((swift_name("onPageDelay")));
...
@property (class, readonly, getter=companion) SharedDataStateCompanion *companion __attribute__((swift_name("companion")));
...
@interface SharedDataStateCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedDataStateCompanion *shared __attribute__((swift_name("shared")));
...
@interface SharedRefinerConfigs : SharedBase
...
- (SharedRefinerConfigs *)doCopyProjectId:(NSString *)projectId apiKey:(NSString *)apiKey userId:(NSString *)userId locale:(NSString * _Nullable)locale __attribute__((swift_name("doCopy(projectId:apiKey:userId:locale:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedFormActionRequest : SharedBase
- (instancetype)initWithFormUuid:(NSString *)formUuid contactRemoteId:(NSString * _Nullable)contactRemoteId __attribute__((swift_name("init(formUuid:contactRemoteId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFormActionRequestCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (SharedFormActionRequest *)doCopyFormUuid:(NSString *)formUuid contactRemoteId:(NSString * _Nullable)contactRemoteId __attribute__((swift_name("doCopy(formUuid:contactRemoteId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedFormActionRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFormActionRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IdentifyUserRequest")))
@interface SharedIdentifyUserRequest : SharedBase
...
@property (class, readonly, getter=companion) SharedIdentifyUserRequestCompanion *companion __attribute__((swift_name("companion")));
- (id _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedIdentifyUserRequest *)doCopyContactAttributes:(id _Nullable)contactAttributes contactRemoteId:(NSString * _Nullable)contactRemoteId isMobileSdk:(BOOL)isMobileSdk locale:(NSString * _Nullable)locale __attribute__((swift_name("doCopy(contactAttributes:contactRemoteId:isMobileSdk:locale:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedIdentifyUserRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedIdentifyUserRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ShowFormRequest")))
@interface SharedShowFormRequest : SharedBase
...
@property (class, readonly, getter=companion) SharedShowFormRequestCompanion *companion __attribute__((swift_name("companion")));
...
- (SharedShowFormRequest *)doCopyManualFormView:(BOOL)manualFormView forceFormView:(BOOL)forceFormView formUuid:(NSString *)formUuid contactRemoteId:(NSString * _Nullable)contactRemoteId isMobileSdk:(BOOL)isMobileSdk locale:(NSString * _Nullable)locale __attribute__((swift_name("doCopy(manualFormView:forceFormView:formUuid:contactRemoteId:isMobileSdk:locale:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable contactRemoteId __attribute__((swift_name("contactRemoteId")));
...
@interface SharedShowFormRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedShowFormRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubmitFormRequest")))
@interface SharedSubmitFormRequest : SharedBase
- (instancetype)initWithContactAttributes:(id _Nullable)contactAttributes accountAttributes:(id _Nullable)accountAttributes isPartialSubmit:(BOOL)isPartialSubmit formUuid:(NSString *)formUuid contactRemoteId:(NSString * _Nullable)contactRemoteId __attribute__((swift_name("init(contactAttributes:accountAttributes:isPartialSubmit:formUuid:contactRemoteId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSubmitFormRequestCompanion *companion __attribute__((swift_name("companion")));
- (id _Nullable)component1 __attribute__((swift_name("component1()")));
- (id _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (SharedSubmitFormRequest *)doCopyContactAttributes:(id _Nullable)contactAttributes accountAttributes:(id _Nullable)accountAttributes isPartialSubmit:(BOOL)isPartialSubmit formUuid:(NSString *)formUuid contactRemoteId:(NSString * _Nullable)contactRemoteId __attribute__((swift_name("doCopy(contactAttributes:accountAttributes:isPartialSubmit:formUuid:contactRemoteId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedSubmitFormRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSubmitFormRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TrackEventRequest")))
@interface SharedTrackEventRequest : SharedBase
...
@property (class, readonly, getter=companion) SharedTrackEventRequestCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedTrackEventRequest *)doCopyEventName:(NSString *)eventName contactRemoteId:(NSString * _Nullable)contactRemoteId isMobileSdk:(BOOL)isMobileSdk locale:(NSString * _Nullable)locale __attribute__((swift_name("doCopy(eventName:contactRemoteId:isMobileSdk:locale:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable contactRemoteId __attribute__((swift_name("contactRemoteId")));
...
@interface SharedTrackEventRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTrackEventRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TrackScreenRequest")))
@interface SharedTrackScreenRequest : SharedBase
...
@property (class, readonly, getter=companion) SharedTrackScreenRequestCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedTrackScreenRequest *)doCopyScreenName:(NSString *)screenName contactRemoteId:(NSString * _Nullable)contactRemoteId isMobileSdk:(BOOL)isMobileSdk locale:(NSString * _Nullable)locale __attribute__((swift_name("doCopy(screenName:contactRemoteId:isMobileSdk:locale:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable contactRemoteId __attribute__((swift_name("contactRemoteId")));
...
@interface SharedTrackScreenRequestCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTrackScreenRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefinerModel")))
@interface SharedRefinerModel : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRefinerModelCompanion *companion __attribute__((swift_name("companion")));
- (id<SharedKotlinx_coroutines_coreFlow>)dismissFormFormActionRequest:(SharedFormActionRequest *)formActionRequest __attribute__((swift_name("dismissForm(formActionRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)identifyUserIdentifyUserRequest:(SharedIdentifyUserRequest *)identifyUserRequest __attribute__((swift_name("identifyUser(identifyUserRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)markFormAsShownFormActionRequest:(SharedFormActionRequest *)formActionRequest __attribute__((swift_name("markFormAsShown(formActionRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)partialSubmitFormSubmitFormRequest:(SharedSubmitFormRequest *)submitFormRequest __attribute__((swift_name("partialSubmitForm(submitFormRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)showFormShowFormRequest:(SharedShowFormRequest *)showFormRequest __attribute__((swift_name("showForm(showFormRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)submitFormSubmitFormRequest:(SharedSubmitFormRequest *)submitFormRequest __attribute__((swift_name("submitForm(submitFormRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)trackEventTrackEventRequest:(SharedTrackEventRequest *)trackEventRequest __attribute__((swift_name("trackEvent(trackEventRequest:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)trackScreenTrackScreenRequest:(SharedTrackScreenRequest *)trackScreenRequest __attribute__((swift_name("trackScreen(trackScreenRequest:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefinerModel.Companion")))
@interface SharedRefinerModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRefinerModelCompanion *shared __attribute__((swift_name("shared")));
@end;
...
@property (class, readonly) SharedEnvironment *test __attribute__((swift_name("test")));
@property (class, readonly) SharedEnvironment *prod __attribute__((swift_name("prod")));
+ (SharedKotlinArray<SharedEnvironment *> *)values __attribute__((swift_name("values()")));
@end;

__attribute__((swift_name("RefinerApi")))
@protocol SharedRefinerApi
@required
...
*/
- (void)dismissFormFormActionRequest:(SharedFormActionRequest *)formActionRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("dismissForm(formActionRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)identifyUserIdentifyUserRequest:(SharedIdentifyUserRequest *)identifyUserRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("identifyUser(identifyUserRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)markFormAsShownFormActionRequest:(SharedFormActionRequest *)formActionRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("markFormAsShown(formActionRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)partialSubmitFormSubmitFormRequest:(SharedSubmitFormRequest *)submitFormRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("partialSubmitForm(submitFormRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)showFormShowFormRequest:(SharedShowFormRequest *)showFormRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("showForm(showFormRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)submitFormSubmitFormRequest:(SharedSubmitFormRequest *)submitFormRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("submitForm(submitFormRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)trackEventTrackEventRequest:(SharedTrackEventRequest *)trackEventRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("trackEvent(trackEventRequest:projectId:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)trackScreenTrackScreenRequest:(SharedTrackScreenRequest *)trackScreenRequest projectId:(NSString *)projectId completionHandler:(void (^)(SharedBaseResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("trackScreen(trackScreenRequest:projectId:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefinerApiImpl")))
@interface SharedRefinerApiImpl : SharedBase <SharedRefinerApi>
- (instancetype)initWithLog:(SharedKermitLogger *)log engine:(id<SharedKtor_client_coreHttpClientEngine>)engine environment:(SharedEnvironment *)environment __attribute__((swift_name("init(log:engine:environment:)"))) __attribute__((objc_designated_initializer));
...
- (NSArray<SharedKotlinx_serialization_jsonJsonElement *> *)toJsonArray __attribute__((swift_name("toJsonArray()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KoinIOSKt")))
@interface SharedKoinIOSKt : SharedBase
+ (SharedKoin_coreKoinApplication *)doInitRefinerSdkSharedUserDefaults:(NSUserDefaults *)userDefaults appInfo:(id<SharedAppInfo>)appInfo logger:(SharedKermitLogger *)logger doOnStartup:(void (^)(void))doOnStartup __attribute__((swift_name("doInitRefinerSdkShared(userDefaults:appInfo:logger:doOnStartup:)")));
...
+ (SharedKoin_coreKoinApplication *)doInitSharedSdkModule:(SharedKoin_coreModule *)sdkModule __attribute__((swift_name("doInitShared(sdkModule:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SerializationExtKt")))
@interface SharedSerializationExtKt : SharedBase
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)addUpdateJsoObject:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)receiver updateJsonObject:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)updateJsonObject __attribute__((swift_name("addUpdateJsoObject(_:updateJsonObject:)")));
+ (NSArray<SharedKotlinx_serialization_jsonJsonElement *> *)toJsonArray:(id)receiver __attribute__((swift_name("toJsonArray(_:)")));
+ (SharedKotlinx_serialization_jsonJsonElement *)toJsonElement:(id _Nullable)receiver __attribute__((swift_name("toJsonElement(_:)")));
+ (NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)toJsonObject:(NSDictionary<id, id> *)receiver __attribute__((swift_name("toJsonObject(_:)")));
